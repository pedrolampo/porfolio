    ...
    <>
      ...
      <Container className="projects-container">
        <Row
          ...
          lg={2}
          xl={2}
          className={betterGUI ? 'mt-2 g-5 py-3' : 'g-5 py-3'}
        >
          {projectsList.map((project) => (
            <Col key={project.id}>
              <Card className="project h-100 text-reset text-decoration-none">
                <a href={project.demoUrl} rel="noreferrer" target="_blank">
                  <img
                    className={project.imgName}
                    alt={project.imgName}
                    src={`media/images/${project.imgName}.png`}
                  />
                </a>
